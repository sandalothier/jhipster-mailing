...
@RestController
@RequestMapping("/api/mailing-kafka")
public class MailingKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MailingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MailingKafkaResource(KafkaProperties kafkaProperties) {
